...
export const CHANGELOG: ChangelogEntry[] = [
	{
		...
		title: 'Fix loading hang and navigation crash',
		summary:
		...
		features: [
			...
			{
				text: '**Loading Hang**: Fixed by ensuring `CampaignService` correctly initializes `localPacksStore` and using `$state.snapshot` to safely clone proxy objects.',
				level: 1
			},
			{
				text: '**Navigation Crash**: Implemented `window.location.href` for "Exit" and "Back" actions in the Player and Builder to clear client state and prevent memory leaks.',
				level: 1
			},
			{
				text: '**Testing**:',
			...
			{
				text: '**E2E Tests**: Added `e2e/play-local-pack.spec.ts` to verify local pack loading and `e2e/navigation-crash.spec.ts` to prevent regression of the navigation crash.',
				level: 1
			},
			{
				text: '**Documentation**:',
			...
			{
				text: 'Updated `walkthrough.md` with verification steps for the fixes.',
				level: 1
			}
		],
		type: 'major'
	},
	{
		...
		features: [
			...
			{
				text: 'Fixed redirect issue for guests accessing Settings and Changelog.',
				level: 1
			},
			{
				text: 'Added "Sign In" button for guests on Settings page.',
				level: 1
			},
			{
			...
			{
				text: 'Implemented indentation for nested lists in the Changelog UI.',
				level: 1
			}
		],
		type: 'patch'
