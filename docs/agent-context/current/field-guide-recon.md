...
Jonas's creator path should start with simple text/voice pages for custom packs. The UI should feel like writing helpful notes for players of his pack, not like maintaining a documentation CMS.
...
- Add a simple Pack Builder Guide tab for text/voice chapters and pages.
...
3. Add optional `guide?: Book` to `LevelPackSchema`.
