...
This document summarizes existing tools and methodologies for teaching computational thinking to pre-readers and early readers. It serves as a competitive analysis and design reference for the "Kibi" project.
...
- **Target Age:** 3-6.
- **Pros vs. Kibi:** Completely screen-free; highly durable; excellent for fine motor skills; "Function" concept is simplified beautifully.
- **Cons vs. Kibi:** Expensive hardware ($200+); limited feedback loop (debugging requires resetting physical blocks); slow execution pace can bore older kids.
...
- **Target Age:** 3+.
- **Pros vs. Kibi:** Zero cost; highly social/collaborative; teaches the _concept_ of code without the abstraction of a device.
- **Cons vs. Kibi:** Requires active adult facilitation; no automated validation of success/failure; hard to scale complexity.
...
- **Pros vs. Kibi:** Excellent scaffolded curriculum; strong school presence; clear visual representation of "flow".
- **Cons vs. Kibi:** Can feel repetitive/rote; "Arrow" logic is abstract compared to narrative actions; less emphasis on creative expression in early levels.
...
- **Target Age:** 4+.
- **Pros vs. Kibi:** High engagement theme (cars/racing); very intuitive "track" metaphor for code execution.
- **Cons vs. Kibi:** Limited scope (mostly just pathfinding); lacks "Stop/Go" or complex interaction mechanics; no narrative depth.
...
- **Target Age:** 5-12.
- **Pros vs. Kibi:** Best-in-class tactile feedback; "Play" button executes the physical code; highly engaging character interaction.
- **Cons vs. Kibi:** Requires expensive hardware kit; setup friction; physical blocks can be lost.
...
- **Target Age:** 5-7.
- **Pros vs. Kibi:** The gold standard for creativity; allows kids to make _their own_ stories; "Message" blocks introduce complex event-driven programming simply.
- **Cons vs. Kibi:** "Blank canvas" can be intimidating; easy to make "spaghetti code" that doesn't work; less guidance for learning specific logic concepts like loops.
...
- **Target Age:** 4-8.
- **Pros vs. Kibi:** Excellent for teaching "Functions" (patterns); very clear "win" state; challenging logic puzzles.
- **Cons vs. Kibi:** Abstract visual style; steep difficulty curve; strictly puzzle-based (no narrative or creativity).
...
- **Target Age:** 5-7.
- **Pros vs. Kibi:** Very simple interface; non-threatening introduction to "command lists".
- **Cons vs. Kibi:** Limited depth; older interface; text-heavy commands (requires some reading) compared to pure icons.

---

## Summary for "Kibi" Design

- **Gap in the Market:** Most apps are either **pure puzzles** (Lightbot, Kodable) or **pure open-ended creation** (ScratchJr). A **narrative-driven** approach (Kibi) that uses "Stop/Go" mechanics to teach flow control within a story context could bridge this gap.
