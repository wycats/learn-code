...
**Why:** It helps the builder understand the *impact* of the configuration.
**Application:**
...
- Moving it to the `BuilderGoalModal` reinforces that it is a *rule* of the level, just like the Par score.
...
- *Future Iteration:* Drag handles on the grid edges to resize the world directly.
